    ...
    <DataStateWrapper loading={loading} error={error}>
      {wins.length === 0 ? (
        ...
        <div className="p-6">
              ...
              <button
                ...
                style={{
                  ...
                  border: activeCategory === cat
                    ? '1px solid rgba(201,160,60,0.35)'
                    : '1px solid rgba(255,255,255,0.08)',
                  background: activeCategory === cat
                    ? 'rgba(201,160,60,0.08)'
                    : 'transparent',
          ...
          {/* Entry count */}
          <div style={{ marginBottom: '16px', fontFamily: 'DM Mono, monospace', fontSize: '10px', letterSpacing: '0.1em', color: 'rgba(255,255,255,0.4)' }}>
            {filtered.length} of {wins.length} wins
          </div>

          {/* Flat 3-column grid — always */}
